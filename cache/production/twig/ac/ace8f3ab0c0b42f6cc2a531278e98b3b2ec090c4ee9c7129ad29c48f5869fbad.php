...
/* viewtopic_body.html */
class __TwigTemplate_9db122c680036acb175b958bd14212a5f509b79dfa3930f72f76706c8aac1b6c extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        ...
        $this->loadTemplate("overall_footer.html", "viewtopic_body.html", 472)->display($context);
        if ($namespace) {
            $this->env->setNamespaceLookUpOrder($previous_look_up_order);
        }
    }
